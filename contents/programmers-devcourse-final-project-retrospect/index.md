...
- Vercel로 배포할 때 모르고 결제를 해버렸다. Vercel의 경우
...
정글에서는 새로운 것을 마주해도 두려워 하지 않는, 평생 배울 수 있는 학습 태도를 갖추게 되었다면 데브코스에서는

조금 더 큰 책임감을 가지고 개발을 하고 싶다.
...
성능 측정, 성능 최적화를 하지 않은 점이 아쉽다. 이력서를 낼 때 수치로 무언가를 나타내고 싶은데
