...
![typescript 에러](./typescript-error.png)
...
![as를 이용해 type 에러 해결하기](./resolve-type-error-by-as.png)
...
![api rewrite](./netlify-rewrite.png)
